...
export function YoutubeMagazineApp(){
 const[jobs,setJobs]=useState<MagazineJob[]>([]),[videos,setVideos]=useState<MagazineVideo[]>([]),[groups,setGroups]=useState<MagazineGroup[]>([]),[busy,setBusy]=useState(false),[error,setError]=useState(""),[notice,setNotice]=useState(""),[preview,setPreview]=useState<MagazinePlan|null>(null);
