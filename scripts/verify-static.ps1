...
if($designAgents.Count-ne 3-or$codeAgents.Count-ne 3){throw "Harness count drift"}
...
Write-Output (@{status="PASS";screens=5;events=15;designAgents=3;codeAgents=3;eventSsot=15}|ConvertTo-Json -Compress)
